...
fun main(args: Array<String>) {
    ...
    println("----16.7----")  //最終手段
    for ((index, monny) in a4.withIndex()) {
        println("${index + 1}年目の時給は ${monny}円です。")
    }
